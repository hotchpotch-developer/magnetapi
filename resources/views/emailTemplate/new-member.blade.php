                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ getSettings('site_url') }}"
                                ...
                                <img src="{{ url('public/images/logo.jpeg') }}" class="logo" alt="Laravel Logo"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; max-height: 75px; width: 100%;">
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Welcome to <strong>{{ $data['company_name'] }}</strong>! We are thrilled to have you on board as our new <strong>{{ $data['designation'] }}</strong> and are excited about the valuable contributions we know you will make to our team.</p>

                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Starting a new job can be both exciting and overwhelming, but please know that we are here to support you every step of the way. Our team is like a family, and we believe that each member brings a unique set of skills and experiences that make us stronger as a whole.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Once again, welcome to <strong>{{ $data['company_name'] }}</strong>. We are confident that you will find your time here both rewarding and fulfilling. If you need anything at all, please do not hesitate to ask. We believe in open communication and are always here to help.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Here’s to a successful and enjoyable journey with us!</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Designation: <strong>{{ $data['designation'] }}</strong></p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Email: <strong>{{ $data['email'] }}</strong></p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="{{ getSettings('site_url') }}"
                                                                                ...
                                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #8c68cd; border-bottom: 8px solid #8c68cd; border-left: 18px solid #8c68cd; border-right: 18px solid #8c68cd; border-top: 8px solid #8c68cd;">Login</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2023 The Magnet. All rights reserved.</p>
